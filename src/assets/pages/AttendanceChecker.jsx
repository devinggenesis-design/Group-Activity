...
const AttendanceChecker = () => {
  ...
  return (
    <div style={styles.container}>
      <div style={{ ...styles.card, backgroundColor: primaryLight, color: primaryDark }}>
        <h2 style={styles.title}>Activity 5: Employee Attendance Checker</h2>
        <p style={styles.subtitle}>Classify attendance status based on decimal time-in (e.g., 8.5 = 8:30 AM)</p>
        ...
        <form onSubmit={handleCheckAttendance} style={styles.form}>
          ...
          <div style={styles.buttonGroup}>
            <button
              type="submit"
              style={{ ...styles.button, backgroundColor: primaryDark, color: primaryLight }}
            >
              Check Attendance
            </button>
            <button
              type="button"
              onClick={handleReset}
              style={{ ...styles.resetButton, borderColor: primaryDark, color: primaryDark }}
            >
              Reset
            </button>
          </div>
        ...
        {result && (
          <div style={{ ...styles.resultPanel, borderColor: primaryDark }}>
            ...
            <p><strong>Employee Name:</strong> {result.name}</p>
            <p><strong>Time In:</strong> {result.timeIn}</p>
            <p><strong>Attendance Status:</strong> {result.status}</p>
